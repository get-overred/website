...
<a name='L88'></a><a href='#L88'>88</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">6x</span>
...
exports.getSrcContent = file =&gt; {
  return new Promise((resolve, reject) =&gt; {
    readFile(file, (error, data) =&gt; {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (error) <span class="cstat-no" title="statement not covered" >reject(error)</span>
...
&nbsp;
  if (attributes.lang) {
    ...
    lang = lang ? lang[1] : <span class="branch-1 cbranch-no" title="branch not covered" >defaultLang</span>
  }
&nbsp;
  return {
...
<span class="cstat-no" title="statement not covered" >    throwError(`Error transforming '${name}'. Message:\n${e.message}`)</span>
  }
}
&nbsp;
