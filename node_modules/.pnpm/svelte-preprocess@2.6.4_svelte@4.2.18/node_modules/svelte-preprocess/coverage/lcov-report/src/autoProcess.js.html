...
<html lang="en">
<head>
    <title>Code coverage report for src/autoProcess.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> autoProcess.js
    </h1>
    <div class='clearfix'>
...
<a name='L160'></a><a href='#L160'>160</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">5x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const stripIndent = require('strip-indent')
const {
  addLanguageAlias,
  getLanguage,
  runTransformer,
...
&nbsp;
  const getTransformerOptions = (lang, alias) =&gt; {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (isFn(transformers[lang])) <span class="cstat-no" title="statement not covered" >return transformers[lang]</span>
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof optionsCache[alias] === 'undefined') {
...
&nbsp;
  const getTransformerTo = targetLanguage =&gt; async ({
    content = <span class="branch-0 cbranch-no" title="branch not covered" >'',</span>
    attributes,
    filename,
  }) =&gt; {
...
&nbsp;
      ...
      const attributes = attributesStr
        ...
        .reduce((acc, attr) =&gt; {
          ...
          acc[name] = value ? value.replace(/['"]/g, '') : <span class="branch-1 cbranch-no" title="branch not covered" >true</span>
          return acc
        }, {})
&nbsp;
