...
<html lang="en">
<head>
    <title>Code coverage report for src/transformers/postcss.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/transformers</a> postcss.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const postcss = require('postcss')
...
&nbsp;
  return process(options.plugins || <span class="branch-1 cbranch-no" title="branch not covered" >[],</span> content, filename, map)
}
&nbsp;</pre></td></tr>
</table></pre>
