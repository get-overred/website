...
var require_dist = __commonJS({
  "node_modules/.pnpm/@upstash+core-analytics@0.0.10/node_modules/@upstash/core-analytics/dist/index.js"(exports2, module2) {
    "use strict";
    ...
    var A2 = (l2, e2, t2, i2) => {
      if (e2 && typeof e2 == "object" || typeof e2 == "function")
        for (let s2 of _2(e2))
          !y2.call(l2, s2) && s2 !== t2 && g2(l2, s2, { get: () => e2[s2], enumerable: !(i2 = k2(e2, s2)) || i2.enumerable });
      return l2;
    };
    var x2 = (l2) => A2(g2({}, "__esModule", { value: true }), l2);
    var S2 = {};
    w2(S2, { Analytics: () => b2 });
    module2.exports = x2(S2);
    var p2 = `
local key = KEYS[1]
local field = ARGV[1]
...
`;
    var b2 = class {
      ...
      parseWindow(e2) {
        ...
        if (!t2.test(e2))
          throw new Error(`Invalid window: ${e2}`);
        let [, i2, s2] = e2.match(t2), n2 = parseInt(i2);
        switch (s2) {
          case "s":
            return n2 * 1e3;
          case "m":
          ...
          default:
            throw new Error(`Invalid window unit: ${s2}`);
        }
      }
      getBucket(e2) {
        let t2 = e2 ?? Date.now();
      ...
      async ingest(e2, ...t2) {
        this.validateTableName(e2), await Promise.all(t2.map(async (i2) => {
          let s2 = this.getBucket(i2.time), n2 = [this.prefix, e2, s2].join(":");
          await this.redis.zincrby(n2, 1, JSON.stringify({ ...i2, time: void 0 }));
        }));
      }
      formatBucketAggregate(e2, t2, i2) {
        let s2 = {};
        return e2.forEach(([n2, r2]) => {
          t2 == "success" && (n2 = n2 === 1 ? "true" : n2 === null ? "false" : n2), s2[t2] = s2[t2] || {}, s2[t2][(n2 ?? "null").toString()] = r2;
        }), { time: i2, ...s2 };
      }
      async aggregateBucket(e2, t2, i2) {
        this.validateTableName(e2);
        let s2 = this.getBucket(i2), n2 = [this.prefix, e2, s2].join(":"), r2 = await this.redis.eval(p2, [n2], [t2]);
        return this.formatBucketAggregate(r2, t2, s2);
      }
      async aggregateBuckets(e2, t2, i2, s2) {
        this.validateTableName(e2);
        let n2 = this.getBucket(s2), r2 = [];
        for (let o2 = 0; o2 < i2; o2 += 1)
          r2.push(this.aggregateBucket(e2, t2, n2)), n2 = n2 - this.bucketSize;
        return Promise.all(r2);
      }
      async aggregateBucketsWithPipeline(e2, t2, i2, s2, n2) {
        this.validateTableName(e2), n2 = n2 ?? 48;
        let r2 = this.getBucket(s2), o2 = [], c2 = this.redis.pipeline(), u2 = [];
        for (let a2 = 1; a2 <= i2; a2 += 1) {
          let d2 = [this.prefix, e2, r2].join(":");
          c2.eval(p2, [d2], [t2]), o2.push(r2), r2 = r2 - this.bucketSize, (a2 % n2 == 0 || a2 == i2) && (u2.push(c2.exec()), c2 = this.redis.pipeline());
        }
        return (await Promise.all(u2)).flat().map((a2, d2) => this.formatBucketAggregate(a2, t2, o2[d2]));
      }
      async getAllowedBlocked(e2, t2, i2) {
        this.validateTableName(e2);
        let s2 = [this.prefix, e2].join(":"), n2 = this.getBucket(i2), r2 = await this.redis.eval(h2, [s2], [n2, this.bucketSize, t2]), o2 = {};
        for (let c2 = 0; c2 < r2.length; c2 += 2) {
          let u2 = r2[c2], m2 = u2.identifier, a2 = +r2[c2 + 1];
          o2[m2] || (o2[m2] = { success: 0, blocked: 0 }), o2[m2][u2.success ? "success" : "blocked"] = a2;
        }
        return o2;
      }
      async getMostAllowedBlocked(e2, t2, i2, s2, n2) {
        this.validateTableName(e2);
        let r2 = [this.prefix, e2].join(":"), o2 = this.getBucket(s2), c2 = n2 ?? i2 * 5, [u2, m2, a2] = await this.redis.eval(f2, [r2], [o2, this.bucketSize, t2, i2, c2]);
        return { allowed: this.toDicts(u2), ratelimited: this.toDicts(m2), denied: this.toDicts(a2) };
      }
      toDicts(e2) {
        let t2 = [];
        for (let i2 = 0; i2 < e2.length; i2 += 1) {
          let s2 = +e2[i2][0], n2 = e2[i2][1];
          t2.push({ identifier: n2.identifier, count: s2 });
        }
        return t2;
      }
    };
...
// node_modules/.pnpm/@upstash+ratelimit@2.0.3/node_modules/@upstash/ratelimit/dist/index.js
var require_dist2 = __commonJS({
  "node_modules/.pnpm/@upstash+ratelimit@2.0.3/node_modules/@upstash/ratelimit/dist/index.js"(exports2, module2) {
    "use strict";
      ...
      static slidingWindow(tokens, window2) {
        ...
        return () => ({
          async limit(ctx, identifier, rate) {
            ...
            const [current, previous, success] = await Promise.any(dbs.map((s2) => s2.request));
            if (success) {
            ...
            const remaining = tokens - usedTokens;
            async function sync() {
              const res = await Promise.all(dbs.map((s2) => s2.request));
          ...
          async getRemaining(ctx, identifier) {
            ...
            const usedTokens = await Promise.any(dbs.map((s2) => s2.request));
            return {
              remaining: Math.max(0, tokens - usedTokens),
...
var require_enc_hex = __commonJS({
  "node_modules/.pnpm/crypto-js@4.2.0/node_modules/crypto-js/enc-hex.js"(exports2, module2) {
    (function(root, factory) {
      if (typeof exports2 === "object") {
...
// netlify/functions/getNplData.ts
var getNplData_exports = {};
__export(getNplData_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(getNplData_exports);

// node_modules/.pnpm/@netlify+functions@2.8.2/node_modules/@netlify/functions/dist/chunk-WACUD2EK.mjs
var BUILDER_FUNCTIONS_FLAG = true;
var HTTP_STATUS_METHOD_NOT_ALLOWED = 405;
var METADATA_VERSION = 1;

// node_modules/.pnpm/@netlify+functions@2.8.2/node_modules/@netlify/functions/dist/chunk-FXC5X2OW.mjs
...
// node_modules/.pnpm/@netlify+functions@2.8.2/node_modules/@netlify/functions/dist/chunk-XSZVKDJB.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/error.mjs
var error_exports = {};
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/version.mjs
var VERSION = "4.68.0";

// node_modules/.pnpm/openai@4.68.0/node_modules/openai/_shims/registry.mjs
var auto = false;
var kind = void 0;
var fetch2 = void 0;
var Request = void 0;
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/_shims/node-runtime.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/_shims/MultipartBody.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/_shims/index.mjs
if (!kind)
  setShims(getRuntime(), { auto: true });

// node_modules/.pnpm/openai@4.68.0/node_modules/openai/internal/decoders/line.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/streaming.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/uploads.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/core.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/internal/qs/formats.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/internal/qs/utils.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/internal/qs/stringify.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/pagination.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/resource.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/resources/chat/completions.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/resources/chat/chat.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/resources/audio/speech.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/resources/audio/transcriptions.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/resources/audio/translations.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/resources/audio/audio.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/resources/batches.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/resources/beta/assistants.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/lib/RunnableFunction.mjs
function isRunnableFunctionWithParse(fn) {
  return typeof fn.parse === "function";
}

// node_modules/.pnpm/openai@4.68.0/node_modules/openai/lib/chatCompletionUtils.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/lib/EventStream.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/lib/parser.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/lib/AbstractChatCompletionRunner.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/lib/ChatCompletionRunner.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/_vendor/partial-json-parser/parser.mjs
var STR = 1;
var NUM = 2;
var ARR = 4;
var OBJ = 8;
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/lib/ChatCompletionStream.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/lib/ChatCompletionStreamingRunner.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/resources/beta/chat/completions.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/resources/beta/chat/chat.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/lib/AssistantStream.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/resources/beta/threads/messages.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/resources/beta/threads/runs/steps.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/resources/beta/threads/runs/runs.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/resources/beta/threads/threads.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/lib/Util.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/resources/beta/vector-stores/files.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/resources/beta/vector-stores/file-batches.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/resources/beta/vector-stores/vector-stores.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/resources/beta/beta.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/resources/completions.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/resources/embeddings.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/resources/files.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/resources/fine-tuning/jobs/checkpoints.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/resources/fine-tuning/jobs/jobs.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/resources/fine-tuning/fine-tuning.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/resources/images.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/resources/models.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/resources/moderations.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/resources/uploads/parts.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/resources/uploads/uploads.mjs
...
// node_modules/.pnpm/openai@4.68.0/node_modules/openai/index.mjs
var _a;
...
function deserialize4(result) {
  ...
  for (const e2 of result) {
    while (e2.length >= 2) {
      const streamId = e2.shift();
      const entries = e2.shift();
      if (!(streamId in obj)) {
        obj[streamId] = {};
      }
...
var AutoPipelineExecutor = class {
  ...
  async withAutoPipeline(executeWithPipeline) {
    const pipeline2 = this.activePipeline ?? this.redis.pipeline();
    if (!this.activePipeline) {
      this.activePipeline = pipeline2;
      this.indexInCurrentPipeline = 0;
    }
    const index = this.indexInCurrentPipeline++;
    executeWithPipeline(pipeline2);
    const pipelineDone = this.deferExecution().then(() => {
      if (!this.pipelinePromises.has(pipeline2)) {
        const pipelinePromise = pipeline2.exec({ keepErrors: true });
        this.pipelineCounter += 1;
        this.pipelinePromises.set(pipeline2, pipelinePromise);
        this.activePipeline = null;
      }
      return this.pipelinePromises.get(pipeline2);
    });
...
var Script = class {
   ...
   */
  digest(s2) {
    return import_enc_hex.default.stringify((0, import_sha1.default)(s2));
  }
};
var Redis = class {
  client;
...
var getNplData = async (event, context) => {
  ...
  const system_message_2 = `
    Create a JSON containing an Instruction pair based on user input.
    The Instruction pair has a Title and an Explainatory.
    The Instruction pair should help the user in finding an HTML-Element on a webage.
    Summarize how to find the HTML-Element in the Title, based solely on position from user input.
    Describe how to find the HTML-Element in the Explainatory, based on entire user input.`;
  ...
  const ratelimit = new import_ratelimit.Ratelimit({
    redis,
    limiter: import_ratelimit.Ratelimit.slidingWindow(50, "86400 s"),
    analytics: true,
  ...
  if (!success) {
    return errorMessage("You are effeced by Rate Limiting");
  }
  const _search_parms = new URLSearchParams(event.rawQuery);
  const _input_data_found = _search_parms.get("data");
  const user_id = _search_parms.get("user_id");
  if (!_input_data_found || !user_id) {
    return errorMessage("The data parameter is null");
  }
  const input_data = JSON.parse(_input_data_found);
  try {
    ...
    const completion = await openai.chat.completions.create({
      ...
      response_format: {
        ...
        json_schema: {
          name: "overred_schema",
          description: "Always returns a Title and an Explainatory, based on the input",
          schema: {
            type: "object",
            properties: {
              title: {
                description: "The Title with a maximum of 50 characters.",
                type: ["string", "null"]
              },
              explain: {
                description: "The Explainatory with a maximum of 200 characters.",
                type: ["string", "null"]
              }
            },
    ...
    console.log(e2);
    return errorMessage("An error occured : " + e2);
  }
};
var handler = wrapHandler(getNplData);
...
*/
//# sourceMappingURL=getNplData.js.map
